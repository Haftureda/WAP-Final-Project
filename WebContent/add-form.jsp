...
<form name="RegForm" action="StudentControllerServlet" method="GET" onsubmit="return validform()">
...
<table>
   <tbody>
      ...
      <td><select  name ="course">
                ...
                <option>MWA</option></select> </td> 
      </tr>
             
        <tr>
      <td> <label></label> </td>
      <td><input type ="submit" name ="submit" value="submit" class="save"></td>
      </tr>      
   </tbody>   
</table>
